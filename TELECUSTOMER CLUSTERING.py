...
train and test on the same dataset will most likely have low
out-of-sample accuracy, due to the likelihood of being over-fit.
...
print("Test set Accuracy: ", metrics.accuracy_score(y_test, yhat),metrics.score(y_train,neigh.predict(X_train)))
